...
startTime = "Mon Mar 23 17:00:00 2020"
endTime = "Mon Mar 23 17:04:00 2020"
######################################################################
filename = os.path.join(os.getcwd(), 'Desktop', filename)
...
print("Successfully Exited at", datetime.now())
myFile.close()
cap.release()
out.release()
